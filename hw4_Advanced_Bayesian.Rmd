...
library(tidyverse)
data <- read.csv('https://raw.githubusercontent.com/agricolamz/2019_data_analysis_for_linguists/master/data/students/AnastasiaOrlenko/hw4_Advanced_Bayesian/hw4_caretta.csv')
